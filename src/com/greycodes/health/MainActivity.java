...
//dapter = new ArrayAdapter<String>(getApplicationContext(), nav_options, textViewResourceId)
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			Toast.makeText(getApplicationContext(), "Nearst hosp", Toast.LENGTH_LONG).show();
break;
		case 2:
